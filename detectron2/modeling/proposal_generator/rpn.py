...
class StandardRPNHead(nn.Module):
    ...
    @configurable
    def __init__(self, *, in_channels: int, rpn_channels: int, num_anchors: int, box_dim: int = 4):
        """
        ...
        self.conv = nn.Conv2d(in_channels, rpn_channels, kernel_size=3, stride=1, padding=1)
        # 1x1 conv for predicting objectness logits
        self.objectness_logits = nn.Conv2d(rpn_channels, num_anchors, kernel_size=1, stride=1)
        # 1x1 conv for predicting box2box transform deltas
        self.anchor_deltas = nn.Conv2d(rpn_channels, num_anchors * box_dim, kernel_size=1, stride=1)
    ...
    def from_config(cls, cfg, input_shape):
        ...
        rpn_channels = cfg.MODEL.RPN.RPN_CHANNELS
        ...
        return {"in_channels": in_channels, "rpn_channels": rpn_channels, "num_anchors": num_anchors[0], "box_dim": box_dim}
