...
def build_optimizer(cfg: CfgNode, model: torch.nn.Module) -> torch.optim.Optimizer:
    ...
    for module in model.modules():
        for key, value in module.named_parameters():
            ...
            if 'lgs' in key:
                lr = cfg.SOLVER.BASE_LR_LGS
                weight_decay = cfg.SOLVER.WEIGHT_DECAY_LGS
                if isinstance(module, norm_module_types):
                    weight_decay = cfg.SOLVER.WEIGHT_DECAY_NORM
                elif key.endswith("bias"):
                    lr = cfg.SOLVER.BASE_LR_LGS * cfg.SOLVER.BIAS_LR_FACTOR
                    weight_decay = cfg.SOLVER.WEIGHT_DECAY_BIAS
    ...
    if optimizer_type == "SGD":
        ...
        optimizer = maybe_add_full_model_gradient_clipping(torch.optim.AdamW)(
            params, cfg.SOLVER.BASE_LR, betas=cfg.SOLVER.ADAMW_BETAS, weight_decay=cfg.SOLVER.WEIGHT_DECAY,
        )
    else:
