...
# ---------------------------------------------------------------------------- #
_C.MODEL.LGSNET = CN()
_C.MODEL.LGSNET.BACKBONE_NAME = 'resnet'
_C.MODEL.LGSNET.IN_FEATURES = []
_C.MODEL.LGSNET.OUT_FEATURES = []
_C.MODEL.LGSNET.K = 7
_C.MODEL.LGSNET.GROUPS = 8
_C.MODEL.LGSNET.HEADS = 64
# ---------------------------------------------------------------------------- #
...
# ---------------------------------------------------------------------------- #
_C.MODEL.SANET = CN()
_C.MODEL.SANET.BACKBONE_NAME = 'resnet'
_C.MODEL.SANET.IN_FEATURES = []
_C.MODEL.SANET.OUT_FEATURES = []
# ---------------------------------------------------------------------------- #
...
_C.MODEL.RPN.RPN_CHANNELS = 1024
...
# ---------------------------------------------------------------------------- #
_C.MODEL.SWIN = CN()
_C.MODEL.SWIN.STRUCTURE = 'swin_small_patch4_window7_224'
...
_C.SOLVER.BASE_LR_LGS = 0.01
_C.SOLVER.MOMENTUM = 0.9
_C.SOLVER.NESTEROV = False
_C.SOLVER.WEIGHT_DECAY = 0.0001
_C.SOLVER.WEIGHT_DECAY_LGS = 0.0001
# The weight decay that's applied to parameters of normalization layers

# (typically the affine transformation)
_C.SOLVER.WEIGHT_DECAY_NORM = 0.0
_C.SOLVER.WEIGHT_DECAY_RELATIVE_POSITION = 0.
_C.SOLVER.GAMMA = 0.1
_C.SOLVER.ADAMW_BETAS = (0.9, 0.999)
