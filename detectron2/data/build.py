...
def get_detection_dataset_dicts(
    ...
    if proposal_files is not None:  # proposal_files=None
...
def build_batch_data_loader(
    dataset, sampler, total_batch_size, *, ims_per_gpu=2, aspect_ratio_grouping=False, num_workers=0
):
    """
...
def build_detection_train_loader(cfg, mapper=None):
    ...
    return build_batch_data_loader(
        ...
        ims_per_gpu=cfg.SOLVER.IMS_PER_GPU,
